...
% For the below, the "result" field f has type U | M & ReadonlyNothing, yielding the constraint (although not solvable as-is):
...
\begin{lstlisting}[float=htbp, caption={Polymorphic Environment Reference}, label={lst:poly-env-ref-b}]
